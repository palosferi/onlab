...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.95\linewidth]{../figures/08_confusion_matrices_recall.png}
    \caption{Recall-normalizált konfúziós mátrixok ugyanazokra a forgatókönyvekre.}
