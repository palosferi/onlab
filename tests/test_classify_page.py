...
CASES = [
    ...
    ("chromium network error page, titled with the hostname",
     "www.ebay.com",
     "<html><div id=\"main-frame-error\">" + "e" * 250_000 +
     " ERR_PROXY_CONNECTION_FAILED </div></html>",
     "https://www.ebay.com", "www.ebay.com", "load_error"),
    ("real page that merely quotes an error code in an article",
